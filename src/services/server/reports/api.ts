...
export const fetchReports = async (params: FetchReportsParams): Promise<FetchReportsResponse> => {
  try {
    ...
    const url = `${env.apiUrl}/reports?${queryParams.toString()}`;
...
export const updateReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/reports/${reportId}`;
...
export const fetchAttributionReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/attribution?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchGoalReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/goals?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchBreakdownReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/breakdown?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchFunnelReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/funnel?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchJourneyReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/journey?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchRetentionReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/retention?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchRevenueReport = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/revenue?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchUtmReport = async (params: UtmReportParams): Promise<UtmReportData> => {
  try {
    ...
    const url = `${env.apiUrl}/analytics/utm?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchSessions = async (params: SessionListParams): Promise<SessionListResponse> => {
  try {
    ...
    const url = `${env.apiUrl}/analytics/sessions?${queryParams.toString()}`;
...
export const fetchSessionStats = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/sessions/stats?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchWeeklySessions = async (
  ...
  try {
    ...
    let url = `${env.apiUrl}/analytics/sessions/weekly?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchSessionDetail = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/sessions/${sessionId}?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchSessionActivity = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/sessions/${sessionId}/activity?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchSessionProperties = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/sessions/${sessionId}/properties?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchSessionDataProperties = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/sessions/session-data/properties?startAt=${startAtMs}&endAt=${endAtMs}`;
...
export const fetchSessionDataValues = async (
  ...
  try {
    ...
    const url = `${env.apiUrl}/analytics/sessions/session-data/values?startAt=${startAtMs}&endAt=${endAtMs}&propertyName=${encodeURIComponent(propertyName)}`;
